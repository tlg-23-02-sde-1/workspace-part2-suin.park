...
public class LoginApp extends JFrame { //LoginApp IS-A JFrame
  ...
  public LoginApp() {
    ...
    loginButton.addActionListener(new InnerLister());
  }
  ...
  private class InnerLister implements ActionListener {
    /**
