...
public class OrderTest {
    ...
    @Before
    public void init() {
        productCart = new ShoppingCart<Product>();             // T? Prduct
    ...
    public void testProcessCart() {
        ...
        order1.processCart(productCart);   // passing ShoppingCart<Product>

        Order order2 = new Order("order-2");
        order2.processCart(musicCart);     // passing ShoppingCart<MusicItem>

        Order order3 = new Order("order-3");
        order3.processCart(mediaCart);     // passing ShoppingCart<MediaCart>
    }
}